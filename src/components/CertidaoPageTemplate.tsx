import { Clock, CheckCircle, FileText, AlertCircle, ArrowLeft, Phone, Mail, ExternalLink, Search, ShieldCheck } from "lucide-react";
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 mb-10">
            ...
            <aside className="lg:col-span-2 space-y-4" aria-label="Informações do serviço">
              {config.infoCards.map((card, i) => {
                ...
                return (
                  <div key={i} className={`border rounded p-4 flex items-start gap-3 ${bgClass}`}>
